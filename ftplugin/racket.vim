...
setl lispwords+=syntax-parse,define/syntax-parse,define-syntax-class,define-splicing-syntax-class,define-simple-macro,define-syntax-parser,define-literal-set,define-conventions
